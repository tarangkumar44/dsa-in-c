/*
Write a function to reverse an array of charcters using pointer arithmetic and loops only.
The function shoud modify the original array in place by swapping elements from start to end using pointers.
